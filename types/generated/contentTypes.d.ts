...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    avatar: Attribute.String &
      Attribute.DefaultTo<'https://res.cloudinary.com/dmgfdleea/image/upload/v1722234437/Home/JobNest/avatar/pjchmiudrfgfasud6nwg.jpg'>;
    province: Attribute.String;
    city: Attribute.String;
    district: Attribute.String;
    postalCode: Attribute.BigInteger;
    type: Attribute.String & Attribute.DefaultTo<'register'>;
